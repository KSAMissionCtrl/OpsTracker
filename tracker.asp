...
<body onload='setupContent()'>
  ...
  <div id='contentContainer'>
    <div id='mainContent'>
      ...
      <div id='aircraftAltitudeKey' style='z-index: 2; border: 2px solid white; background-color: black; width: 132px; position: absolute; top: 747px; left: 814px; display: none;'>
        <span id='alt1' style='color:#267F00'>Test</span><br>
        <span id='alt2' style='color:#00FF21'>Test</span><br>
        <span id='alt3' style='color:#0094FF'>Test</span><br>
        <span id='alt4' style='color:#00FFFF'>Test</span><br>
        <span id='alt5' style='color:#FFD800'>Test</span><br>
        <span id='alt6' style='color:#FF6A00'>Test</span><br>
        <span id='alt7' style='color:#FF0000'>Test</span><br>
